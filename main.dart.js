...
ad:[function(a,b){return a==null?b==null:a===b},"$2","N3",4,0,18],
xv:[function(a){return H.CU(a)},"$1","J2",2,0,19],
...
return H.J(new H.xy(z,b),[H.Z(z,0),null])},
...
Zf:{
"^":"r:2;",
$1:function(a){return!!J.t(a).$iscv}}}],["","",,F,{
"^":"",
Iq:[function(){var z,y,x,w,v,u
document.querySelector("#subtitle").textContent="by Marco"
$.X=document.querySelector("#todo-input")
$.L=document.querySelector("#todo-button")
$.U=document.querySelector("#todo-list")
$.Q=document.querySelector("#doing-list")
$.M=document.querySelector("#done-list")
z=J.V($.L)
H.J(new W.O(0,z.Q,z.a,W.Y(F.T()),z.b),[H.Z(z,0)]).Y()
y=W.J6("#")
y.textContent="\u21e7 Add More Todo's \u21e7"
z=J.R(y)
z.gDD(y).h(0,"list-group-item")
z=z.gVl(y)
H.J(new W.O(0,z.Q,z.a,W.Y(F.W()),z.b),[H.Z(z,0)]).Y()
J.OG($.U).h(0,y)
x=W.J6("#")
x.textContent="Follow @codemakery ;-)"
z=J.R(x)
z.gDD(x).h(0,"list-group-item")
z=z.gVl(x)
H.J(new W.O(0,z.Q,z.a,W.Y(F.W()),z.b),[H.Z(z,0)]).Y()
J.OG($.U).h(0,x)
w=W.J6("#")
w.textContent="Enjoy Dart Programming"
z=J.R(w)
z.gDD(w).h(0,"list-group-item")
z=z.gVl(w)
H.J(new W.O(0,z.Q,z.a,W.Y(F.W()),z.b),[H.Z(z,0)]).Y()
J.OG($.Q).h(0,w)
v=W.J6("#")
v.textContent="Learn HTML"
z=J.R(v)
z.gDD(v).h(0,"list-group-item")
z=z.gVl(v)
H.J(new W.O(0,z.Q,z.a,W.Y(F.W()),z.b),[H.Z(z,0)]).Y()
J.OG($.M).h(0,v)
u=W.J6("#")
u.textContent="Learn CSS"
z=J.R(u)
z.gDD(u).h(0,"list-group-item")
z=z.gVl(u)
H.J(new W.O(0,z.Q,z.a,W.Y(F.W()),z.b),[H.Z(z,0)]).Y()
J.OG($.M).h(0,u)},"$0","KW",0,0,1],
N:[function(a){var z,y
z=W.J6(null)
J.r0(z,"#")
z.textContent=J.SW($.X)
new W.I4(z).h(0,"list-group-item")
y=H.J(new W.Cq(z,"click",!1),[null])
H.J(new W.O(0,y.Q,y.a,W.Y(F.W()),y.b),[H.Z(y,0)]).Y()
J.OG($.U).h(0,z)
J.eW($.X,"")},"$1","T",2,0,20],
P:[function(a){var z,y
z=J.G0(a)
y=J.R(z)
if(J.mG(y.geT(z),$.U))J.OG($.Q).h(0,z)
else if(J.mG(y.geT(z),$.Q))J.OG($.M).h(0,z)
else y.wg(z)},"$1","W",2,0,20]},1],]
...
init.metadata=[{func:"NT"},{func:"X0",void:true},{func:"aB",args:[null]},{func:"TS",args:[null,P.I]},{func:"uO",args:[P.I]},{func:"cO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.Gz]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.Gz]},{func:"N5",void:true,args:[null,P.Gz]},{func:"bh",args:[null,null]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.I,args:[P.KN]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"G5",void:true,args:[null]},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"qh",void:true,args:[W.ea]},,];$=null
